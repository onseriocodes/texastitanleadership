...
const Hero = () => {
  return (
    <>
      <div
        className="relative flex items-center justify-center bg-cover bg-center sm:min-h-screen lg:min-h-auto py-20 lg:py-32"
      ...
      >
        ...
        <div className="relative container mx-auto px-4 text-center lg:text-left lg:flex lg:items-center">
